<template>
  <AppLayout>
    ...
    <div class="flex flex-col items-center mb-24">
      ...
      <h1 class="font-bold font-title text-3xl md:text-5xl lg:text-6xl mb-2 bg-gradient-to-r from-[#31333f] to-[#393d48] text-transparent bg-clip-text">Scripture Alone</h1>
